# Contributing to Eclipse Fennec — Data Atlas
...
* This repository: https://github.com/eclipse-fennec/data.atlas
* Issue tracker: https://github.com/eclipse-fennec/data.atlas/issues
...
* Search the [issue tracker](https://github.com/eclipse-fennec/data.atlas/issues)
...
2. Add any newly cleared dependencies to a `DEPENDENCIES` file at the
   repository root (create it if it does not exist yet).
...
* Issues: https://github.com/eclipse-fennec/data.atlas/issues

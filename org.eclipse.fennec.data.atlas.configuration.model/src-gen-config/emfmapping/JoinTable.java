 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.JoinTable#getJoinColumn <em>Join Column</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getInverseJoinColumn <em>Inverse Join Column</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getInverseForeignKey <em>Inverse Foreign Key</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getUniqueConstraint <em>Unique Constraint</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getIndex <em>Index</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.JoinTable#getSchema <em>Schema</em>}</li>
 * </ul>
 *
 * @see emfmapping.EmfmappingPackage#getJoinTable()
...
public interface JoinTable extends EObject {
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_JoinColumn()
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_ForeignKey()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link emfmapping.JoinTable#getForeignKey <em>Foreign Key</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_InverseJoinColumn()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_InverseForeignKey()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link emfmapping.JoinTable#getInverseForeignKey <em>Inverse Foreign Key</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_UniqueConstraint()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_Index()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_Catalog()
	...
	/**
	 * Sets the value of the '{@link emfmapping.JoinTable#getCatalog <em>Catalog</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see emfmapping.EmfmappingPackage#getJoinTable_Name()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link emfmapping.JoinTable#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see emfmapping.EmfmappingPackage#getJoinTable_Schema()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link emfmapping.JoinTable#getSchema <em>Schema</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

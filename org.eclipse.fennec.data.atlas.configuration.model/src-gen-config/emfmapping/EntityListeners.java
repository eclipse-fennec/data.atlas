 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.EntityListeners#getEntityListener <em>Entity Listener</em>}</li>
 * </ul>
 *
 * @see emfmapping.EmfmappingPackage#getEntityListeners()
...
public interface EntityListeners extends EObject {
	 ...
	 * The list contents are of type {@link emfmapping.EntityListener}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Entity Listener</em>' containment reference list.
	 * @see emfmapping.EmfmappingPackage#getEntityListeners_EntityListener()

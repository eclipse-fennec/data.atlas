 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.NamedEntityGraph#getNamedAttributeNode <em>Named Attribute Node</em>}</li>
 *   <li>{@link emfmapping.NamedEntityGraph#getSubgraph <em>Subgraph</em>}</li>
 *   <li>{@link emfmapping.NamedEntityGraph#getSubclassSubgraph <em>Subclass Subgraph</em>}</li>
 *   <li>{@link emfmapping.NamedEntityGraph#isIncludeAllAttributes <em>Include All Attributes</em>}</li>
 *   <li>{@link emfmapping.NamedEntityGraph#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see emfmapping.EmfmappingPackage#getNamedEntityGraph()
...
public interface NamedEntityGraph extends EObject {
	 ...
	 * The list contents are of type {@link emfmapping.NamedAttributeNode}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Named Attribute Node</em>' containment reference list.
	 * @see emfmapping.EmfmappingPackage#getNamedEntityGraph_NamedAttributeNode()
	 ...
	 * The list contents are of type {@link emfmapping.NamedSubgraph}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Subgraph</em>' containment reference list.
	 * @see emfmapping.EmfmappingPackage#getNamedEntityGraph_Subgraph()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getNamedEntityGraph_SubclassSubgraph()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getNamedEntityGraph_IncludeAllAttributes()
	...
	/**
	 * Sets the value of the '{@link emfmapping.NamedEntityGraph#isIncludeAllAttributes <em>Include All Attributes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link emfmapping.NamedEntityGraph#isIncludeAllAttributes <em>Include All Attributes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetIncludeAllAttributes()
	 * @see #isIncludeAllAttributes()
	...
	/**
	 * Returns whether the value of the '{@link emfmapping.NamedEntityGraph#isIncludeAllAttributes <em>Include All Attributes</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see emfmapping.EmfmappingPackage#getNamedEntityGraph_Name()
	...
	/**
	 * Sets the value of the '{@link emfmapping.NamedEntityGraph#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

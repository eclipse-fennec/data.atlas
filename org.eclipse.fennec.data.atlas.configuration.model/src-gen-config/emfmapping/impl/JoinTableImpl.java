 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getJoinColumn <em>Join Column</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getInverseJoinColumn <em>Inverse Join Column</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getInverseForeignKey <em>Inverse Foreign Key</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getUniqueConstraint <em>Unique Constraint</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.JoinTableImpl#getSchema <em>Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinTableImpl extends MinimalEObjectImpl.Container implements JoinTable {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.JOIN_TABLE;
	}

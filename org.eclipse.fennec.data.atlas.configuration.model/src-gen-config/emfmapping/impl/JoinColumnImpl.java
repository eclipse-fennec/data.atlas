 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#getReferencedColumnName <em>Referenced Column Name</em>}</li>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#getTable <em>Table</em>}</li>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link emfmapping.impl.JoinColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinColumnImpl extends MinimalEObjectImpl.Container implements JoinColumn {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.JOIN_COLUMN;
	}
	...
	public void setColumnDefinition(String newColumnDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__COLUMN_DEFINITION, oldColumnDefinition, columnDefinition));
	}
	...
	public void setInsertable(boolean newInsertable) {
		...
		insertableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__INSERTABLE, oldInsertable, insertable, !oldInsertableESet));
	}
	...
	public void unsetInsertable() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.JOIN_COLUMN__INSERTABLE, oldInsertable, INSERTABLE_EDEFAULT, oldInsertableESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__NAME, oldName, name));
	}
	...
	public void setNullable(boolean newNullable) {
		...
		nullableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__NULLABLE, oldNullable, nullable, !oldNullableESet));
	}
	...
	public void unsetNullable() {
		...
		nullableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.JOIN_COLUMN__NULLABLE, oldNullable, NULLABLE_EDEFAULT, oldNullableESet));
	}
	...
	public void setReferencedColumnName(String newReferencedColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__REFERENCED_COLUMN_NAME, oldReferencedColumnName, referencedColumnName));
	}
	...
	public void setTable(String newTable) {
		...
		table = newTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__TABLE, oldTable, table));
	}
	...
	public void setUnique(boolean newUnique) {
		...
		uniqueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__UNIQUE, oldUnique, unique, !oldUniqueESet));
	}
	...
	public void unsetUnique() {
		...
		uniqueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.JOIN_COLUMN__UNIQUE, oldUnique, UNIQUE_EDEFAULT, oldUniqueESet));
	}
	...
	public void setUpdatable(boolean newUpdatable) {
		...
		updatableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.JOIN_COLUMN__UPDATABLE, oldUpdatable, updatable, !oldUpdatableESet));
	}
	...
	public void unsetUpdatable() {
		...
		updatableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.JOIN_COLUMN__UPDATABLE, oldUpdatable, UPDATABLE_EDEFAULT, oldUpdatableESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmappingPackage.JOIN_COLUMN__COLUMN_DEFINITION:
				return getColumnDefinition();
			case EmfmappingPackage.JOIN_COLUMN__INSERTABLE:
				return isInsertable();
			case EmfmappingPackage.JOIN_COLUMN__NAME:
				return getName();
			case EmfmappingPackage.JOIN_COLUMN__NULLABLE:
				return isNullable();
			case EmfmappingPackage.JOIN_COLUMN__REFERENCED_COLUMN_NAME:
				return getReferencedColumnName();
			case EmfmappingPackage.JOIN_COLUMN__TABLE:
				return getTable();
			case EmfmappingPackage.JOIN_COLUMN__UNIQUE:
				return isUnique();
			case EmfmappingPackage.JOIN_COLUMN__UPDATABLE:
				return isUpdatable();
		}

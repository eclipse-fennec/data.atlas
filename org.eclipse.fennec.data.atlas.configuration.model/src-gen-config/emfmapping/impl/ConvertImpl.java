 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.ConvertImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.ConvertImpl#getAttributeName <em>Attribute Name</em>}</li>
 *   <li>{@link emfmapping.impl.ConvertImpl#getConverter <em>Converter</em>}</li>
 *   <li>{@link emfmapping.impl.ConvertImpl#isDisableConversion <em>Disable Conversion</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConvertImpl extends MinimalEObjectImpl.Container implements Convert {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.CONVERT;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.CONVERT__DESCRIPTION, oldDescription, description));
	}
	...
	public void setAttributeName(String newAttributeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.CONVERT__ATTRIBUTE_NAME, oldAttributeName, attributeName));
	}
	...
	public void setConverter(String newConverter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.CONVERT__CONVERTER, oldConverter, converter));
	}
	...
	public void setDisableConversion(boolean newDisableConversion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.CONVERT__DISABLE_CONVERSION, oldDisableConversion, disableConversion, !oldDisableConversionESet));
	}
	...
	public void unsetDisableConversion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.CONVERT__DISABLE_CONVERSION, oldDisableConversion, DISABLE_CONVERSION_EDEFAULT, oldDisableConversionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmappingPackage.CONVERT__DESCRIPTION:
				return getDescription();
			case EmfmappingPackage.CONVERT__ATTRIBUTE_NAME:
				return getAttributeName();
			case EmfmappingPackage.CONVERT__CONVERTER:
				return getConverter();
			case EmfmappingPackage.CONVERT__DISABLE_CONVERSION:

 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.PrimaryKeyJoinColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link emfmapping.impl.PrimaryKeyJoinColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.PrimaryKeyJoinColumnImpl#getReferencedColumnName <em>Referenced Column Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimaryKeyJoinColumnImpl extends MinimalEObjectImpl.Container implements PrimaryKeyJoinColumn {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.PRIMARY_KEY_JOIN_COLUMN;
	}
	...
	public void setColumnDefinition(String newColumnDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.PRIMARY_KEY_JOIN_COLUMN__COLUMN_DEFINITION, oldColumnDefinition, columnDefinition));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.PRIMARY_KEY_JOIN_COLUMN__NAME, oldName, name));
	}
	...
	public void setReferencedColumnName(String newReferencedColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.PRIMARY_KEY_JOIN_COLUMN__REFERENCED_COLUMN_NAME, oldReferencedColumnName, referencedColumnName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmappingPackage.PRIMARY_KEY_JOIN_COLUMN__COLUMN_DEFINITION:
				return getColumnDefinition();
			case EmfmappingPackage.PRIMARY_KEY_JOIN_COLUMN__NAME:
				return getName();
			case EmfmappingPackage.PRIMARY_KEY_JOIN_COLUMN__REFERENCED_COLUMN_NAME:

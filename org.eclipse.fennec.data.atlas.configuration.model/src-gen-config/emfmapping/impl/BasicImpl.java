 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.BasicImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#getLob <em>Lob</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#getEnumerated <em>Enumerated</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#getConvert <em>Convert</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.BasicImpl#isOptional <em>Optional</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicImpl extends MinimalEObjectImpl.Container implements Basic {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.BASIC;
	}

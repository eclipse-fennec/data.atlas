 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getIdClass <em>Id Class</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getExcludeDefaultListeners <em>Exclude Default Listeners</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getExcludeSuperclassListeners <em>Exclude Superclass Listeners</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getEntityListeners <em>Entity Listeners</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getPrePersist <em>Pre Persist</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getPostPersist <em>Post Persist</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getPreRemove <em>Pre Remove</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getPostRemove <em>Post Remove</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getPreUpdate <em>Pre Update</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getPostUpdate <em>Post Update</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getPostLoad <em>Post Load</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link emfmapping.impl.MappedSuperclassImpl#isMetadataComplete <em>Metadata Complete</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappedSuperclassImpl extends MinimalEObjectImpl.Container implements MappedSuperclass {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.MAPPED_SUPERCLASS;
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.AttributesImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getId <em>Id</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getEmbeddedId <em>Embedded Id</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getBasic <em>Basic</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getManyToOne <em>Many To One</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getOneToMany <em>One To Many</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getOneToOne <em>One To One</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getManyToMany <em>Many To Many</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getElementCollection <em>Element Collection</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getEmbedded <em>Embedded</em>}</li>
 *   <li>{@link emfmapping.impl.AttributesImpl#getTransient <em>Transient</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributesImpl extends MinimalEObjectImpl.Container implements Attributes {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.ATTRIBUTES;
	}

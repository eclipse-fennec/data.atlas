 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getUniqueConstraint <em>Unique Constraint</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getAllocationSize <em>Allocation Size</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getPkColumnName <em>Pk Column Name</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getPkColumnValue <em>Pk Column Value</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getTable <em>Table</em>}</li>
 *   <li>{@link emfmapping.impl.TableGeneratorImpl#getValueColumnName <em>Value Column Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableGeneratorImpl extends MinimalEObjectImpl.Container implements TableGenerator {
	/**
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.TABLE_GENERATOR;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<UniqueConstraint> getUniqueConstraint() {
		if (uniqueConstraint == null) {
			uniqueConstraint = new EObjectContainmentEList<UniqueConstraint>(UniqueConstraint.class, this, EmfmappingPackage.TABLE_GENERATOR__UNIQUE_CONSTRAINT);
		}
	...
	public EList<Index> getIndex() {
		if (index == null) {
			index = new EObjectContainmentEList<Index>(Index.class, this, EmfmappingPackage.TABLE_GENERATOR__INDEX);
		}
		return index;
	}
	...
	public void setAllocationSize(int newAllocationSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__ALLOCATION_SIZE, oldAllocationSize, allocationSize, !oldAllocationSizeESet));
	}
	...
	public void unsetAllocationSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.TABLE_GENERATOR__ALLOCATION_SIZE, oldAllocationSize, ALLOCATION_SIZE_EDEFAULT, oldAllocationSizeESet));
	}
	...
	public void setCatalog(String newCatalog) {
		...
		catalog = newCatalog;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__CATALOG, oldCatalog, catalog));
	}
	...
	public void setInitialValue(int newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__INITIAL_VALUE, oldInitialValue, initialValue, !oldInitialValueESet));
	}
	...
	public void unsetInitialValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.TABLE_GENERATOR__INITIAL_VALUE, oldInitialValue, INITIAL_VALUE_EDEFAULT, oldInitialValueESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__NAME, oldName, name));
	}
	...
	public void setPkColumnName(String newPkColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__PK_COLUMN_NAME, oldPkColumnName, pkColumnName));
	}
	...
	public void setPkColumnValue(String newPkColumnValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__PK_COLUMN_VALUE, oldPkColumnValue, pkColumnValue));
	}
	...
	public void setSchema(String newSchema) {
		...
		schema = newSchema;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__SCHEMA, oldSchema, schema));
	}
	...
	public void setTable(String newTable) {
		...
		table = newTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__TABLE, oldTable, table));
	}
	...
	public void setValueColumnName(String newValueColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.TABLE_GENERATOR__VALUE_COLUMN_NAME, oldValueColumnName, valueColumnName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfmappingPackage.TABLE_GENERATOR__UNIQUE_CONSTRAINT:
				return ((InternalEList<?>)getUniqueConstraint()).basicRemove(otherEnd, msgs);
			case EmfmappingPackage.TABLE_GENERATOR__INDEX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmappingPackage.TABLE_GENERATOR__DESCRIPTION:
				return getDescription();
			case EmfmappingPackage.TABLE_GENERATOR__UNIQUE_CONSTRAINT:
				return getUniqueConstraint();
			case EmfmappingPackage.TABLE_GENERATOR__INDEX:
				return getIndex();
			case EmfmappingPackage.TABLE_GENERATOR__ALLOCATION_SIZE:
				return getAllocationSize();
			case EmfmappingPackage.TABLE_GENERATOR__CATALOG:
				return getCatalog();
			case EmfmappingPackage.TABLE_GENERATOR__INITIAL_VALUE:
				return getInitialValue();
			case EmfmappingPackage.TABLE_GENERATOR__NAME:
				return getName();
			case EmfmappingPackage.TABLE_GENERATOR__PK_COLUMN_NAME:
				return getPkColumnName();
			case EmfmappingPackage.TABLE_GENERATOR__PK_COLUMN_VALUE:
				return getPkColumnValue();
			case EmfmappingPackage.TABLE_GENERATOR__SCHEMA:
				return getSchema();
			case EmfmappingPackage.TABLE_GENERATOR__TABLE:
				return getTable();
			case EmfmappingPackage.TABLE_GENERATOR__VALUE_COLUMN_NAME:

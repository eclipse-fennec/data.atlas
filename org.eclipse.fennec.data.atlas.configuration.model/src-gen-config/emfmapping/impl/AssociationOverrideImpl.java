 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.AssociationOverrideImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.AssociationOverrideImpl#getJoinColumn <em>Join Column</em>}</li>
 *   <li>{@link emfmapping.impl.AssociationOverrideImpl#getForeignKey <em>Foreign Key</em>}</li>
 *   <li>{@link emfmapping.impl.AssociationOverrideImpl#getJoinTable <em>Join Table</em>}</li>
 *   <li>{@link emfmapping.impl.AssociationOverrideImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationOverrideImpl extends MinimalEObjectImpl.Container implements AssociationOverride {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.ASSOCIATION_OVERRIDE;
	}

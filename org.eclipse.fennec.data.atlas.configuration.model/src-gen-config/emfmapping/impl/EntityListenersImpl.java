 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.EntityListenersImpl#getEntityListener <em>Entity Listener</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityListenersImpl extends MinimalEObjectImpl.Container implements EntityListeners {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.ENTITY_LISTENERS;
	}
	...
	public EList<EntityListener> getEntityListener() {
		if (entityListener == null) {
			entityListener = new EObjectContainmentEList<EntityListener>(EntityListener.class, this, EmfmappingPackage.ENTITY_LISTENERS__ENTITY_LISTENER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfmappingPackage.ENTITY_LISTENERS__ENTITY_LISTENER:

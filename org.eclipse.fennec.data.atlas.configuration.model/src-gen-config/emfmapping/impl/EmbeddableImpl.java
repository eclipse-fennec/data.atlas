 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.EmbeddableImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.EmbeddableImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link emfmapping.impl.EmbeddableImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link emfmapping.impl.EmbeddableImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link emfmapping.impl.EmbeddableImpl#isMetadataComplete <em>Metadata Complete</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmbeddableImpl extends MinimalEObjectImpl.Container implements Embeddable {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.EMBEDDABLE;
	}

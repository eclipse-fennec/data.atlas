 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.EntityResultImpl#getFieldResult <em>Field Result</em>}</li>
 *   <li>{@link emfmapping.impl.EntityResultImpl#getDiscriminatorColumn <em>Discriminator Column</em>}</li>
 *   <li>{@link emfmapping.impl.EntityResultImpl#getEntityClass <em>Entity Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityResultImpl extends MinimalEObjectImpl.Container implements EntityResult {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.ENTITY_RESULT;
	}
	...
	public EList<FieldResult> getFieldResult() {
		if (fieldResult == null) {
			fieldResult = new EObjectContainmentEList<FieldResult>(FieldResult.class, this, EmfmappingPackage.ENTITY_RESULT__FIELD_RESULT);
		}
		return fieldResult;
	}
	...
	public void setDiscriminatorColumn(String newDiscriminatorColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.ENTITY_RESULT__DISCRIMINATOR_COLUMN, oldDiscriminatorColumn, discriminatorColumn));
	}
	...
	public void setEntityClass(String newEntityClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.ENTITY_RESULT__ENTITY_CLASS, oldEntityClass, entityClass));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfmappingPackage.ENTITY_RESULT__FIELD_RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EmfmappingPackage.ENTITY_RESULT__DISCRIMINATOR_COLUMN:
				return getDiscriminatorColumn();
			case EmfmappingPackage.ENTITY_RESULT__ENTITY_CLASS:

 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getPrePersist <em>Pre Persist</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getPostPersist <em>Post Persist</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getPreRemove <em>Pre Remove</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getPostRemove <em>Post Remove</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getPreUpdate <em>Pre Update</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getPostUpdate <em>Post Update</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getPostLoad <em>Post Load</em>}</li>
 *   <li>{@link emfmapping.impl.EntityListenerImpl#getClass_ <em>Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityListenerImpl extends MinimalEObjectImpl.Container implements EntityListener {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.ENTITY_LISTENER;
	}

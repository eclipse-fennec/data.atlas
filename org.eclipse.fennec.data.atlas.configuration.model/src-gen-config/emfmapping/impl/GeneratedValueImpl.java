 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.GeneratedValueImpl#getGenerator <em>Generator</em>}</li>
 *   <li>{@link emfmapping.impl.GeneratedValueImpl#getStrategy <em>Strategy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneratedValueImpl extends MinimalEObjectImpl.Container implements GeneratedValue {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.GENERATED_VALUE;
	}
	...
	public void setGenerator(String newGenerator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.GENERATED_VALUE__GENERATOR, oldGenerator, generator));
	}
	...
	public void setStrategy(GenerationType newStrategy) {
		...
		strategyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.GENERATED_VALUE__STRATEGY, oldStrategy, strategy, !oldStrategyESet));
	}
	...
	public void unsetStrategy() {
		...
		strategyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.GENERATED_VALUE__STRATEGY, oldStrategy, STRATEGY_EDEFAULT, oldStrategyESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmappingPackage.GENERATED_VALUE__GENERATOR:
				return getGenerator();
			case EmfmappingPackage.GENERATED_VALUE__STRATEGY:
				return getStrategy();
		}

 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.SecondaryTableImpl#getPrimaryKeyJoinColumn <em>Primary Key Join Column</em>}</li>
 *   <li>{@link emfmapping.impl.SecondaryTableImpl#getPrimaryKeyForeignKey <em>Primary Key Foreign Key</em>}</li>
 *   <li>{@link emfmapping.impl.SecondaryTableImpl#getUniqueConstraint <em>Unique Constraint</em>}</li>
 *   <li>{@link emfmapping.impl.SecondaryTableImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link emfmapping.impl.SecondaryTableImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link emfmapping.impl.SecondaryTableImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.SecondaryTableImpl#getSchema <em>Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecondaryTableImpl extends MinimalEObjectImpl.Container implements SecondaryTable {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.SECONDARY_TABLE;
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.OrderColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link emfmapping.impl.OrderColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link emfmapping.impl.OrderColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.OrderColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link emfmapping.impl.OrderColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderColumnImpl extends MinimalEObjectImpl.Container implements OrderColumn {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.ORDER_COLUMN;
	}

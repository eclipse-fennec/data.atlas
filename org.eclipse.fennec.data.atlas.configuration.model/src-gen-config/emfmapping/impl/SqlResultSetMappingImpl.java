 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.SqlResultSetMappingImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.SqlResultSetMappingImpl#getEntityResult <em>Entity Result</em>}</li>
 *   <li>{@link emfmapping.impl.SqlResultSetMappingImpl#getConstructorResult <em>Constructor Result</em>}</li>
 *   <li>{@link emfmapping.impl.SqlResultSetMappingImpl#getColumnResult <em>Column Result</em>}</li>
 *   <li>{@link emfmapping.impl.SqlResultSetMappingImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SqlResultSetMappingImpl extends MinimalEObjectImpl.Container implements SqlResultSetMapping {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.SQL_RESULT_SET_MAPPING;
	}

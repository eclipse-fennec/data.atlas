 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.EntityImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getTable <em>Table</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getSecondaryTable <em>Secondary Table</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPrimaryKeyJoinColumn <em>Primary Key Join Column</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPrimaryKeyForeignKey <em>Primary Key Foreign Key</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getIdClass <em>Id Class</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getInheritance <em>Inheritance</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getDiscriminatorValue <em>Discriminator Value</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getDiscriminatorColumn <em>Discriminator Column</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getSequenceGenerator <em>Sequence Generator</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getTableGenerator <em>Table Generator</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getNamedQuery <em>Named Query</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getNamedNativeQuery <em>Named Native Query</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getNamedStoredProcedureQuery <em>Named Stored Procedure Query</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getSqlResultSetMapping <em>Sql Result Set Mapping</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getExcludeDefaultListeners <em>Exclude Default Listeners</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getExcludeSuperclassListeners <em>Exclude Superclass Listeners</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getEntityListeners <em>Entity Listeners</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPrePersist <em>Pre Persist</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPostPersist <em>Post Persist</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPreRemove <em>Pre Remove</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPostRemove <em>Post Remove</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPreUpdate <em>Pre Update</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPostUpdate <em>Post Update</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getPostLoad <em>Post Load</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getAttributeOverride <em>Attribute Override</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getAssociationOverride <em>Association Override</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getConvert <em>Convert</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getNamedEntityGraph <em>Named Entity Graph</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#isCacheable <em>Cacheable</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#isMetadataComplete <em>Metadata Complete</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.EntityImpl#getClass_ <em>Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.ENTITY;
	}

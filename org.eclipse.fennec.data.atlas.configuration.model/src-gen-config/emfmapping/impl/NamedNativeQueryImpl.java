 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.NamedNativeQueryImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.NamedNativeQueryImpl#getQuery <em>Query</em>}</li>
 *   <li>{@link emfmapping.impl.NamedNativeQueryImpl#getHint <em>Hint</em>}</li>
 *   <li>{@link emfmapping.impl.NamedNativeQueryImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.NamedNativeQueryImpl#getResultClass <em>Result Class</em>}</li>
 *   <li>{@link emfmapping.impl.NamedNativeQueryImpl#getResultSetMapping <em>Result Set Mapping</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedNativeQueryImpl extends MinimalEObjectImpl.Container implements NamedNativeQuery {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.NAMED_NATIVE_QUERY;
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.NamedEntityGraphImpl#getNamedAttributeNode <em>Named Attribute Node</em>}</li>
 *   <li>{@link emfmapping.impl.NamedEntityGraphImpl#getSubgraph <em>Subgraph</em>}</li>
 *   <li>{@link emfmapping.impl.NamedEntityGraphImpl#getSubclassSubgraph <em>Subclass Subgraph</em>}</li>
 *   <li>{@link emfmapping.impl.NamedEntityGraphImpl#isIncludeAllAttributes <em>Include All Attributes</em>}</li>
 *   <li>{@link emfmapping.impl.NamedEntityGraphImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedEntityGraphImpl extends MinimalEObjectImpl.Container implements NamedEntityGraph {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.NAMED_ENTITY_GRAPH;
	}
	...
	public EList<NamedAttributeNode> getNamedAttributeNode() {
		if (namedAttributeNode == null) {
			namedAttributeNode = new EObjectContainmentEList<NamedAttributeNode>(NamedAttributeNode.class, this, EmfmappingPackage.NAMED_ENTITY_GRAPH__NAMED_ATTRIBUTE_NODE);
		}
	...
	public EList<NamedSubgraph> getSubgraph() {
		if (subgraph == null) {
			subgraph = new EObjectContainmentEList<NamedSubgraph>(NamedSubgraph.class, this, EmfmappingPackage.NAMED_ENTITY_GRAPH__SUBGRAPH);
		}
		return subgraph;
	}
	...
	public EList<NamedSubgraph> getSubclassSubgraph() {
		if (subclassSubgraph == null) {
			subclassSubgraph = new EObjectContainmentEList<NamedSubgraph>(NamedSubgraph.class, this, EmfmappingPackage.NAMED_ENTITY_GRAPH__SUBCLASS_SUBGRAPH);
		}
	...
	public void setIncludeAllAttributes(boolean newIncludeAllAttributes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.NAMED_ENTITY_GRAPH__INCLUDE_ALL_ATTRIBUTES, oldIncludeAllAttributes, includeAllAttributes, !oldIncludeAllAttributesESet));
	}
	...
	public void unsetIncludeAllAttributes() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.NAMED_ENTITY_GRAPH__INCLUDE_ALL_ATTRIBUTES, oldIncludeAllAttributes, INCLUDE_ALL_ATTRIBUTES_EDEFAULT, oldIncludeAllAttributesESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.NAMED_ENTITY_GRAPH__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmfmappingPackage.NAMED_ENTITY_GRAPH__NAMED_ATTRIBUTE_NODE:
				return ((InternalEList<?>)getNamedAttributeNode()).basicRemove(otherEnd, msgs);
			case EmfmappingPackage.NAMED_ENTITY_GRAPH__SUBGRAPH:
				return ((InternalEList<?>)getSubgraph()).basicRemove(otherEnd, msgs);
			case EmfmappingPackage.NAMED_ENTITY_GRAPH__SUBCLASS_SUBGRAPH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EmfmappingPackage.NAMED_ENTITY_GRAPH__INCLUDE_ALL_ATTRIBUTES:
				return isIncludeAllAttributes();
			case EmfmappingPackage.NAMED_ENTITY_GRAPH__NAME:
				return getName();
		}

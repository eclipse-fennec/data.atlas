 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.SequenceGeneratorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link emfmapping.impl.SequenceGeneratorImpl#getAllocationSize <em>Allocation Size</em>}</li>
 *   <li>{@link emfmapping.impl.SequenceGeneratorImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link emfmapping.impl.SequenceGeneratorImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link emfmapping.impl.SequenceGeneratorImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.SequenceGeneratorImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link emfmapping.impl.SequenceGeneratorImpl#getSequenceName <em>Sequence Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceGeneratorImpl extends MinimalEObjectImpl.Container implements SequenceGenerator {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.SEQUENCE_GENERATOR;
	}

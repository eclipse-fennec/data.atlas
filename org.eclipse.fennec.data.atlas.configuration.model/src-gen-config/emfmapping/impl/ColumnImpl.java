 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.ColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#isInsertable <em>Insertable</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#getLength <em>Length</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#getTable <em>Table</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link emfmapping.impl.ColumnImpl#isUpdatable <em>Updatable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.COLUMN;
	}

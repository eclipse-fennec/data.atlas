 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.impl.InheritanceImpl#getStrategy <em>Strategy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InheritanceImpl extends MinimalEObjectImpl.Container implements Inheritance {
	...
	protected EClass eStaticClass() {
		return EmfmappingPackage.Literals.INHERITANCE;
	}
	...
	public void setStrategy(InheritanceType newStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfmappingPackage.INHERITANCE__STRATEGY, oldStrategy, strategy, !oldStrategyESet));
	}
	...
	public void unsetStrategy() {
		...
		strategyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EmfmappingPackage.INHERITANCE__STRATEGY, oldStrategy, STRATEGY_EDEFAULT, oldStrategyESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfmappingPackage.INHERITANCE__STRATEGY:
				return getStrategy();
		}

...
import emfmapping.Attributes;
import emfmapping.Basic;
import emfmapping.CascadeType;
import emfmapping.CollectionTable;
import emfmapping.Column;
import emfmapping.ColumnResult;
import emfmapping.ConstraintMode;
import emfmapping.ConstructorResult;
import emfmapping.Convert;
import emfmapping.Converter;
import emfmapping.DiscriminatorColumn;
import emfmapping.DiscriminatorType;
import emfmapping.DocumentRoot;
import emfmapping.ElementCollection;
import emfmapping.Embeddable;
import emfmapping.EmbeddableAttributes;
import emfmapping.Embedded;
import emfmapping.EmbeddedId;
import emfmapping.EmfmappingFactory;
import emfmapping.EmfmappingPackage;
import emfmapping.EmptyType;
import emfmapping.Entity;
import emfmapping.EntityListener;
import emfmapping.EntityListeners;
import emfmapping.EntityMappingsType;
import emfmapping.EntityResult;
import emfmapping.EnumType;
import emfmapping.FetchType;
import emfmapping.FieldResult;
import emfmapping.ForeignKey;
import emfmapping.GeneratedValue;
import emfmapping.GenerationType;
import emfmapping.Id;
import emfmapping.IdClass;
import emfmapping.Index;
import emfmapping.Inheritance;
import emfmapping.InheritanceType;
import emfmapping.JoinColumn;
import emfmapping.JoinTable;
import emfmapping.Lob;
import emfmapping.LockModeType;
import emfmapping.ManyToMany;
import emfmapping.ManyToOne;
import emfmapping.MapKey;
import emfmapping.MapKeyClass;
import emfmapping.MapKeyColumn;
import emfmapping.MapKeyJoinColumn;
import emfmapping.MappedSuperclass;
import emfmapping.NamedAttributeNode;
import emfmapping.NamedEntityGraph;
import emfmapping.NamedNativeQuery;
import emfmapping.NamedQuery;
import emfmapping.NamedStoredProcedureQuery;
import emfmapping.NamedSubgraph;
import emfmapping.OneToMany;
import emfmapping.OneToOne;
import emfmapping.OrderColumn;
import emfmapping.ParameterMode;
import emfmapping.PersistenceUnitDefaults;
import emfmapping.PersistenceUnitMetadata;
import emfmapping.PostLoad;
import emfmapping.PostPersist;
import emfmapping.PostRemove;
import emfmapping.PostUpdate;
import emfmapping.PrePersist;
import emfmapping.PreRemove;
import emfmapping.PreUpdate;
import emfmapping.PrimaryKeyJoinColumn;
import emfmapping.QueryHint;
import emfmapping.SecondaryTable;
import emfmapping.SequenceGenerator;
import emfmapping.SqlResultSetMapping;
import emfmapping.StoredProcedureParameter;
import emfmapping.Table;
import emfmapping.TableGenerator;
import emfmapping.TemporalType;
import emfmapping.Transient;
import emfmapping.UniqueConstraint;
import emfmapping.Version;

import emfmapping.util.EmfmappingValidator;
...
import org.eclipse.fennec.data.atlas.configuration.impl.DAConfigPackageImpl;
...
public class EmfmappingPackageImpl extends EPackageImpl implements EmfmappingPackage {
	 ...
	 * @see emfmapping.EmfmappingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static EmfmappingPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(DAConfigPackage.eNS_URI);
		DAConfigPackageImpl theDAConfigPackage = (DAConfigPackageImpl)(registeredPackage instanceof DAConfigPackageImpl ? registeredPackage : DAConfigPackage.eINSTANCE);
	...
	public EReference getBasic_Name() {
		return (EReference)basicEClass.getEStructuralFeatures().get(7);
	}
	...
	public EReference getEmbeddable_Class() {
		return (EReference)embeddableEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getEntity_Class() {
		return (EReference)entityEClass.getEStructuralFeatures().get(34);
	}
	...
	public EReference getEntityListener_Class() {
		return (EReference)entityListenerEClass.getEStructuralFeatures().get(8);
	}
	...
	public EReference getIdClass_Class() {
		return (EReference)idClassEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getMapKeyClass_Class() {
		return (EReference)mapKeyClassEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getStoredProcedureParameter_Class() {
		return (EReference)storedProcedureParameterEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(basicEClass, BASIC__NAME);
		...
		createEReference(converterEClass, CONVERTER__CLASS);
		...
		createEReference(embeddableEClass, EMBEDDABLE__CLASS);
		...
		createEReference(entityEClass, ENTITY__CLASS);
		...
		createEReference(entityListenerEClass, ENTITY_LISTENER__CLASS);
		...
		createEReference(idClassEClass, ID_CLASS__CLASS);
		...
		createEReference(mapKeyClassEClass, MAP_KEY_CLASS__CLASS);
		...
		createEReference(mappedSuperclassEClass, MAPPED_SUPERCLASS__CLASS);
		...
		createEReference(storedProcedureParameterEClass, STORED_PROCEDURE_PARAMETER__CLASS);
	...
	public void initializePackageContents() {
		...
		initEReference(getBasic_Name(), ecorePackage.getEStructuralFeature(), null, "name", null, 1, 1, Basic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConverter_Class(), ecorePackage.getEClass(), null, "class", null, 1, 1, Converter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEmbeddable_Class(), ecorePackage.getEClass(), null, "class", null, 1, 1, Embeddable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntity_Class(), ecorePackage.getEClassifier(), null, "class", null, 1, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntityListener_Class(), ecorePackage.getEClass(), null, "class", null, 1, 1, EntityListener.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIdClass_Class(), ecorePackage.getEClass(), null, "class", null, 1, 1, IdClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMapKeyClass_Class(), ecorePackage.getEClass(), null, "class", null, 1, 1, MapKeyClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMappedSuperclass_Class(), ecorePackage.getEClass(), null, "class", null, 1, 1, MappedSuperclass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getStoredProcedureParameter_Class(), ecorePackage.getEClass(), null, "class", null, 1, 1, StoredProcedureParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

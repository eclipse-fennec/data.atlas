 ...
 * </p>
 * <ul>
 *   <li>{@link emfmapping.EmbeddableAttributes#getBasic <em>Basic</em>}</li>
 *   <li>{@link emfmapping.EmbeddableAttributes#getManyToOne <em>Many To One</em>}</li>
 *   <li>{@link emfmapping.EmbeddableAttributes#getOneToMany <em>One To Many</em>}</li>
 *   <li>{@link emfmapping.EmbeddableAttributes#getOneToOne <em>One To One</em>}</li>
 *   <li>{@link emfmapping.EmbeddableAttributes#getManyToMany <em>Many To Many</em>}</li>
 *   <li>{@link emfmapping.EmbeddableAttributes#getElementCollection <em>Element Collection</em>}</li>
 *   <li>{@link emfmapping.EmbeddableAttributes#getEmbedded <em>Embedded</em>}</li>
 *   <li>{@link emfmapping.EmbeddableAttributes#getTransient <em>Transient</em>}</li>
 * </ul>
 *
 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes()
...
public interface EmbeddableAttributes extends EObject {
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_Basic()
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_ManyToOne()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_OneToMany()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_OneToOne()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_ManyToMany()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_ElementCollection()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_Embedded()
	 * @model containment="true"
	 ...
	 * @see emfmapping.EmfmappingPackage#getEmbeddableAttributes_Transient()
	 * @model containment="true"

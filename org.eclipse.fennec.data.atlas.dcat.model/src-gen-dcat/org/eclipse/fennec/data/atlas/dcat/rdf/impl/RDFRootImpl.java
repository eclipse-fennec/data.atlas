 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getAbout <em>About</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getDatatype <em>Datatype</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getNodeID <em>Node ID</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.rdf.impl.RDFRootImpl#getRDF <em>RDF</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RDFRootImpl extends MinimalEObjectImpl.Container implements RDFRoot {
	...
	public EMap<String, String> getXMLNSPrefixMap() {
		if (xMLNSPrefixMap == null) {
			xMLNSPrefixMap = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, RdfPackage.RDF_ROOT__XMLNS_PREFIX_MAP);
		}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, RdfPackage.RDF_ROOT__XSI_SCHEMA_LOCATION);
		}

/*
 */
package org.eclipse.fennec.data.atlas.dcat.skos.configuration;
...
import org.eclipse.fennec.data.atlas.dcat.skos.util.SkosResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.skos.util.SkosResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.fennec.data.atlas.dcat.skos.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.skos.SkosFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.skos\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.skos.SkosPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.skos\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.skos\"" })
...
public class SkosConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(SkosPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(SkosPackage.eNS_URI, ePackage);
		}

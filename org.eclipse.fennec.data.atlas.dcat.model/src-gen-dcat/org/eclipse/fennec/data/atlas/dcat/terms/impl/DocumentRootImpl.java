/*
 */
package org.eclipse.fennec.data.atlas.dcat.terms.impl;
...
import org.eclipse.fennec.data.atlas.dcat.terms.DocumentRoot;
import org.eclipse.fennec.data.atlas.dcat.terms.LicenseDocument;
import org.eclipse.fennec.data.atlas.dcat.terms.Location;
import org.eclipse.fennec.data.atlas.dcat.terms.PeriodOfTime;
import org.eclipse.fennec.data.atlas.dcat.terms.ProvenanceStatement;
import org.eclipse.fennec.data.atlas.dcat.terms.RightsStatement;
import org.eclipse.fennec.data.atlas.dcat.terms.Standard;
import org.eclipse.fennec.data.atlas.dcat.terms.TermsPackage;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAccessRights <em>Access Rights</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAccrualMethod <em>Accrual Method</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAccrualPeriodicity <em>Accrual Periodicity</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAccrualPolicy <em>Accrual Policy</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAlternative <em>Alternative</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAudience <em>Audience</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getAvailable <em>Available</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getBibliographicCitation <em>Bibliographic Citation</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getConformsTo <em>Conforms To</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getCreated <em>Created</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getCreator <em>Creator</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getDateAccepted <em>Date Accepted</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getDateCopyrighted <em>Date Copyrighted</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getDateSubmitted <em>Date Submitted</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getEducationLevel <em>Education Level</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getExtent <em>Extent</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getHasFormat <em>Has Format</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getHasPart <em>Has Part</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getHasVersion <em>Has Version</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getInstructionalMethod <em>Instructional Method</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIsFormatOf <em>Is Format Of</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIsPartOf <em>Is Part Of</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIsReferencedBy <em>Is Referenced By</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIsReplacedBy <em>Is Replaced By</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIsRequiredBy <em>Is Required By</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIssued <em>Issued</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getIsVersionOf <em>Is Version Of</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getLicense <em>License</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getMediator <em>Mediator</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getMedium <em>Medium</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getModified <em>Modified</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getProvenance <em>Provenance</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getReferences <em>References</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getReplaces <em>Replaces</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getRequires <em>Requires</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getRights <em>Rights</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getRightsHolder <em>Rights Holder</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getSpatial <em>Spatial</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getTableOfContents <em>Table Of Contents</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getTemporal <em>Temporal</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.fennec.data.atlas.dcat.terms.impl.DocumentRootImpl#getValid <em>Valid</em>}</li>
 * </ul>
 *
 * @generated
 */

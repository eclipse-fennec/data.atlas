/*
 */
package org.eclipse.fennec.data.atlas.dcat.dcatde.configuration;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.dcatde.DcatDEFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.dcatde\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.dcatde.DcatDEPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.dcatde\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.dcatde\"" })
...
public class DcatDEConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(DcatDEPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(DcatDEPackage.eNS_URI, ePackage);
		}

/*
 */
package org.eclipse.fennec.data.atlas.dcat.rdf.configuration;
...
import org.eclipse.fennec.data.atlas.dcat.rdf.util.RdfResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.rdf.util.RdfResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.fennec.data.atlas.dcat.rdf.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.rdf.RdfFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.rdf\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.rdf.RdfPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.rdf\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.rdf\"" })
...
public class RdfConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(RdfPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(RdfPackage.eNS_URI, ePackage);
		}

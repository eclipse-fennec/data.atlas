/*
 */
package org.eclipse.fennec.data.atlas.dcat.locn.configuration;
...
import org.eclipse.fennec.data.atlas.dcat.locn.util.LocnResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.locn.util.LocnResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.fennec.data.atlas.dcat.locn.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.locn.LocnFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.locn\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.data.atlas.dcat.locn.LocnPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.locn\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.data.atlas.dcat.locn\"" })
...
public class LocnConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(LocnPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(LocnPackage.eNS_URI, ePackage);
		}

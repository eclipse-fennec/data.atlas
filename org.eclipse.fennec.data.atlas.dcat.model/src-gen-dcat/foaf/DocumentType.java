 ...
 * </p>
 * <ul>
 *   <li>{@link foaf.DocumentType#getName <em>Name</em>}</li>
 *   <li>{@link foaf.DocumentType#getAbout <em>About</em>}</li>
 *   <li>{@link foaf.DocumentType#getNodeID <em>Node ID</em>}</li>
 * </ul>
 *
 * @see foaf.FoafPackage#getDocumentType()
...
public interface DocumentType extends EObject {
	 ...
	 * @see foaf.FoafPackage#getDocumentType_Name()
	 ...
	 * @see #setAbout(String)
	 * @see foaf.FoafPackage#getDocumentType_About()
	...
	/**
	 * Sets the value of the '{@link foaf.DocumentType#getAbout <em>About</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see foaf.FoafPackage#getDocumentType_NodeID()
	...
	/**
	 * Sets the value of the '{@link foaf.DocumentType#getNodeID <em>Node ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

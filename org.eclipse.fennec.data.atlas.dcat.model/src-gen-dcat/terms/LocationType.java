 ...
 * </p>
 * <ul>
 *   <li>{@link terms.LocationType#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link terms.LocationType#getPrefLabel <em>Pref Label</em>}</li>
 *   <li>{@link terms.LocationType#getAbout <em>About</em>}</li>
 *   <li>{@link terms.LocationType#getNodeID <em>Node ID</em>}</li>
 * </ul>
 *
 * @see terms.TermsPackage#getLocationType()
...
public interface LocationType extends EObject {
	 ...
	 * The list contents are of type {@link rdf.TypedLiteral}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Geometry</em>' containment reference list.
	 * @see terms.TermsPackage#getLocationType_Geometry()
	 ...
	 * @see terms.TermsPackage#getLocationType_PrefLabel()
	 * @model containment="true"
	 ...
	 * @see #setAbout(String)
	 * @see terms.TermsPackage#getLocationType_About()
	...
	/**
	 * Sets the value of the '{@link terms.LocationType#getAbout <em>About</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see terms.TermsPackage#getLocationType_NodeID()
	...
	/**
	 * Sets the value of the '{@link terms.LocationType#getNodeID <em>Node ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

 ...
 * </p>
 * <ul>
 *   <li>{@link vcard.impl.AddressTypeImpl#getStreetAddress <em>Street Address</em>}</li>
 *   <li>{@link vcard.impl.AddressTypeImpl#getLocality <em>Locality</em>}</li>
 *   <li>{@link vcard.impl.AddressTypeImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link vcard.impl.AddressTypeImpl#getCountryName <em>Country Name</em>}</li>
 *   <li>{@link vcard.impl.AddressTypeImpl#getAbout <em>About</em>}</li>
 *   <li>{@link vcard.impl.AddressTypeImpl#getNodeID <em>Node ID</em>}</li>
 * </ul>
 *
 * @generated
 */

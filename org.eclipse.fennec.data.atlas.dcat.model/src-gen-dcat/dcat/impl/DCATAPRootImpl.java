 ...
 * </p>
 * <ul>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getCatalogRecord <em>Catalog Record</em>}</li>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getDataService <em>Data Service</em>}</li>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getDataset <em>Dataset</em>}</li>
 *   <li>{@link dcat.impl.DCATAPRootImpl#getDistribution <em>Distribution</em>}</li>
 * </ul>
 *
 * @generated
 */
